...
const HeroSection = ({openSignIn, openSignUp}) => {
    return (
        <div className="landing-page-content relative">
            <div className='absoulte inset-0 bg-gradient-to-r from-purple-50 to-indigo-50 opacity-80 z-0 pointer-events-none'></div>
                    ...
                    <div className="text-center">
                        ...
                        <div className='mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center'>
                            <div className='space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5'>
                                ...
                                onClick={()=>openSignUp()}
                                >Get Started</button>
                                <button className='flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-100 md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-lg hover:shadow-xl'
                                onClick={()=>openSignIn()}
                                >Sign In</button>
                            </div>
                        </div>
