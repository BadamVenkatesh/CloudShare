    ...
    return (
        <div className='py-20 bg-gray-50'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 gap-8'>
                        ...
                        <div key={index} className={`flex flex-col rounded-lg shadow-lg overflow-hidden ${plan.highlighted ? 'border-2 border-purple-500 transform scale-105' : 'border border-gray-200'}`}>
                            <div className={`px-6 py-8 bg-white ${plan.highlighted?'bg-gradient-to-br from-purple-50 to-white':""}`}>
                                <div className='flex justify-between items-center'>
                                    ...
                                    {plan.highlighted && (
                                        <span className='inline-flex items-center px-3 py=0.5 rounded-full text-sm font-medium text-gray-100
                                        bg-purple-500 '> Popular</span>
                                    )}
                                </div>
                            ...
                            <div className='flex-1 flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6'>
                                ...
                                <div className='rounded-md shadow'>
                                    <button className={`w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md ${plan.highlighted? 'text-white bg-purple-500 hover:bg-purple-600':
