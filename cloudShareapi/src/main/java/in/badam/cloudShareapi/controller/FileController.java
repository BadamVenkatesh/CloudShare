...
import in.badam.cloudShareapi.service.FileMetadataService;
...
public class FileController {
    ...
    public ResponseEntity<Resource> download(@PathVariable String id) throws IOException, MalformedURLException {
